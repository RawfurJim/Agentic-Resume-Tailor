 ...
 * @property {boolean} [descriptionTruncated] True when `description` is a
 *                               teaser the source cut short (Adzuna and Reed
 *                               search payloads). full-description.mjs then
 *                               fetches the whole posting for NEW offers; a
 *                               miss keeps the teaser. Absent = as complete
 ...
 * @property {string}             [company_label]  Company name recorded on every job from this entry,
 *                                                 replacing the provider's (boards that name the hiring
 *                                                 entity, e.g. amazon.jobs). Applied by scan.mjs.
