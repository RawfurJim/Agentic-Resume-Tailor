...
import { jsonLdNodes } from './_jsonld.mjs';
...
export default {
  ...
  async enrichDate(job, ctx) {
    ...
    // Every JSON-LD node, whatever shape the tenant wrapped it in (bare object,
    // array, @graph) — shared with full-description.mjs via _jsonld.mjs. The
    // `type=` attribute is not reliably first (CSP nonces), handled there.
    const nodes = jsonLdNodes(String(html));
